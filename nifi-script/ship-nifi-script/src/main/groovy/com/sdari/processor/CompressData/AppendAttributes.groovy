    ...
    static def calculation(params) {
        ...
        for (int i = 0; i < dataList.size(); i++) {
            try {//详细处理流程
                ...
                String append = '>_<' + jsonAttributesFormer.getString('sid') + '>_<' +  jsonAttributesFormer.getString('ship.collect.protocol') + '>_<' +  jsonAttributesFormer.getString('ship.collect.freq') + '>_<' +  jsonAttributesFormer.getString('compress.type')
