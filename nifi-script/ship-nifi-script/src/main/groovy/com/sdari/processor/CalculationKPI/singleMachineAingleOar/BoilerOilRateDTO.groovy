 ...
 *
 * @type: （单机单桨）
 * @kpiName: 锅炉油耗率* @author Liumouren* @date 2020-09-21 16:16:00
 */
class BoilerOilRateDTO {
    ...
    BoilerOilRateDTO(final def logger, final int pid, final String pName, final int rid, GroovyObject pch) {
        log = logger
        processorId = pid
        processorName = pName
        routeId = rid
