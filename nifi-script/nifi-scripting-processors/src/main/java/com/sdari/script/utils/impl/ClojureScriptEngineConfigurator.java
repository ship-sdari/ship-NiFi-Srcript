 ...
 */
package com.sdari.script.utils.impl;

import com.sdari.script.processors.engine.ClojureScriptEngine;
...
public class ClojureScriptEngineConfigurator extends AbstractModuleClassloaderConfigurator {
    ...
    private static final String PRELOADS =
            "(:import \n"
                    ...
                    + "[org.apache.nifi.com.sdari.processor "
                    ...
                    + "]\n"
                    + "[org.apache.nifi.com.sdari.processor.exception FlowFileAccessException FlowFileHandlingException MissingFlowFileException ProcessException]\n"
                    + "[org.apache.nifi.com.sdari.processor.io InputStreamCallback OutputStreamCallback StreamCallback]\n"
                    + "[org.apache.nifi.com.sdari.processor.util FlowFileFilters StandardValidators]\n"
